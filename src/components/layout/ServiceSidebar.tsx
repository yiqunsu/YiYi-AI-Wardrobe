/**
 * ServiceSidebar [module: components / layout]
 * Left sidebar navigation shared across all /service/* pages.
 * Contains icon links to Create, Wardrobe, Collection, and History.
