/**
 * Navbar [module: components / layout]
 * Marketing site top navigation bar shared across all public pages.
 * Shows logo, page links, and an auth-aware Login/Dashboard button.
 */
"use client";
