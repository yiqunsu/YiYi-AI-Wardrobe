/**
 * ServiceNavbar [module: components / layout]
 * Top navigation bar shared across all /service/* pages.
 * Shows the YiYi logo, the user's display name/avatar, and a logout option.
 */
"use client";
...
import HeadBar from "@/components/service/HeadBar";
