/**
 * RegisterForm [module: components / auth]
 * New account registration form (email, password, display name) with inline validation.
 * Includes a Google OAuth alternative via GoogleLoginButton.
 */
"use client";
