/**
 * DatePicker [module: components / service]
 * Calendar-style date input used in DesignForm for the user to select
 * which day they want an outfit recommendation for.
 */
"use client";
